      ...
      <div style={{ maxWidth:1200, margin:'0 auto', padding:'28px 24px' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:14, marginBottom:20 }}>
          {[
            ...
            { label:'En cours',          value:stats.en_cours,  color:'#a855f7', bg:'rgba(168,85,247,.1)', border:'rgba(168,85,247,.2)' },
        ...
        <div className="overlay" onClick={() => setModalValidation(null)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:13 }}>
              <div><label style={{ fontSize:'11.5px', fontWeight:600, color:'var(--text-secondary)', marginBottom:'5px', display:'block' }}>Quantité produite *</label><input className="input-field" type="number" min="0" value={valForm.quantite_produite} onChange={e => setValForm({...valForm,quantite_produite:e.target.value})}/></div>
              <div><label style={{ fontSize:'11.5px', fontWeight:600, color:'var(--text-secondary)', marginBottom:'5px', display:'block' }}>Quantité rebutée</label><input className="input-field" type="number" min="0" value={valForm.quantite_rebutee} onChange={e => setValForm({...valForm,quantite_rebutee:e.target.value})}/></div>
              <div><label style={{ fontSize:'11.5px', fontWeight:600, color:'var(--text-secondary)', marginBottom:'5px', display:'block' }}>Observations</label><textarea className="input-field" rows={3} value={valForm.observations} onChange={e => setValForm({...valForm,observations:e.target.value} as any)}/></div>
